...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (path.contains("/swagger-ui") || path.contains("/users/login") || path.contains("/users/signup") || path.contains("/favicon.ico") || path.contains("/swagger-resources") || path.contains("/v2/api-docs") || path.contains("/swagger-ui/index.html") || path.contains("/users/kakaoLogin") || path.startsWith("/webjars") || path.startsWith("/ws") || path.startsWith("/users/sms") || path.startsWith("/shop")) {
